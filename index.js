function handleFormSubmit(event) {
    ...
    axios.post('https://crudcrud.com/api/593c6729033e4c4cae23180e836d562d/expensetracker',expenseData)
    .then((response) => {
        showscreen(response.data._id,expenseData)
    })
    .catch((err)=>{
   ...
   window.addEventListener("DOMContentLoaded",()=>{
    axios.get('https://crudcrud.com/api/593c6729033e4c4cae23180e836d562d/expensetracker')
    .then((response)=>{
...
function deleteExpense(key, listItem) {
    axios.delete(`https://crudcrud.com/api/593c6729033e4c4cae23180e836d562d/expensetracker/${key}`)
    .then(() => {
